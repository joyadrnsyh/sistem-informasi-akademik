  ...
  return (
    <div className="space-y-6 animate-fade-in text-left">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 text-left">
        <div>
          <h1 className="text-2xl font-bold tracking-tight text-stone-800 m-0">Admin Dashboard</h1>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 text-left">
            ...
            <div className="glass p-6 rounded-2xl flex flex-col justify-between h-full">
              ...
              <div className="mt-4 pt-4 border-t border-stone-200/60 flex justify-between items-center text-xs text-stone-500">
                ...
                <span className="px-2.5 py-0.5 rounded-full bg-emerald-50 text-emerald-700 border border-emerald-200/50 font-semibold uppercase tracking-wider text-[10px]">
                  Aktif
                </span>
              </div>
            </div>
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            <div className="relative max-w-sm w-full">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-2 bg-white border border-stone-200 rounded-xl text-sm text-stone-800 placeholder-stone-400 focus:outline-none focus:border-indigo-500"
              />
            </div>
            <Button
              variant="primary"
                ...
                header: 'Nama Lengkap', key: 'name', render: (val, row) => (
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <span className="text-[10px] text-stone-400">{row.email}</span>
                    </div>
                  </div>
                )
              },
      ...
      {activeTab === 'courses' && (
        <div className="space-y-4 text-left">
          <div className="flex justify-between items-center">
            <h3 className="font-bold text-stone-800">Daftar Matakuliah Master</h3>
            <Button
              variant="primary"
              icon={Plus}
      ...
      {activeTab === 'schedules' && (
        <div className="space-y-4 text-left">
          <div className="flex justify-between items-center">
            <h3 className="font-bold text-stone-800">Jadwal Kuliah Aktif</h3>
            <Button
              variant="primary"
              icon={Plus}
