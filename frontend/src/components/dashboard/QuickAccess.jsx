...
export const QuickAccess = ({ onNavigate }) => {
  ...
  return (
    <div className="bg-white border border-stone-200/80 rounded-2xl p-5 shadow-xs text-left h-full flex flex-col">
      <h3 className="text-sm font-bold text-stone-800 pb-3 border-b border-stone-100 mb-4">Akses Cepat</h3>
        ...
        {items.map((item, idx) => {
          ...
          return (
            <button
              ...
              className="flex flex-col items-center justify-center p-2.5 bg-white hover:bg-stone-50 border border-stone-200 rounded-xl shadow-2xs transition-all cursor-pointer group"
            >
