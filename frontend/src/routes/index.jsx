    ...
    return (
      <div className="min-h-screen bg-[#070a13] flex items-center justify-center text-slate-400">
        <div className="flex flex-col items-center gap-3">
          ...
          <span className="text-xs font-semibold uppercase tracking-wider">Memuat Portal...</span>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen bg-[#070a13] flex items-center justify-center p-4">
      <div className="glass p-8 rounded-2xl max-w-sm text-center">
        <div className="inline-flex h-12 w-12 items-center justify-center rounded-2xl bg-rose-500/10 text-rose-400 border border-rose-500/20 mb-4 text-xl font-bold">
          !
        </div>
...
const NavigateButton = () => {
  ...
  return (
    <a 
      ...
      className="mt-5 inline-block w-full py-2 bg-slate-800 hover:bg-slate-700 text-slate-200 font-semibold text-xs rounded-xl border border-slate-700 transition-colors"
    >
